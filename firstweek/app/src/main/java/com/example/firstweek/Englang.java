...
public class Englang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_englang);

        TextView txtSpeechInput = (TextView) findViewById(R.id.txtSpeechInput);
        Speak = (ImageButton) findViewById(R.id.Speak2);
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT){
            if (resultCode == RESULT_OK){
                ...
                if (result.size() == 0) {
                    ...
                    if(userinput.toUpperCase().equals("START OBSTACLE DETECTION")||userinput.toUpperCase().equals("رہنمائی")){
                    ...
                    else if(userinput.toUpperCase().equals("EXIT")||userinput.toUpperCase().equals("روانگی")) {
                        finish();
                        System.exit(0);
